...
const Home = () => {
  return (
    <div className="max-w-[1512px] mx-auto bg-white">
      ...
      <img src="./assets/images/5.png" className="w-full h-screen" />
      ...
      <div className="grid grid-cols-2 h-screen">
        <div className="flex justify-center flex-col items-center">
          ...
          <p className="font-Noto w-[200px] font-light leading-relaxed text-justify">
            ...
            living embodiment of the artist's soul, a mirror reflecting the
      ...
      <img src="./assets/images/9.png" className="w-full h-screen" />
